...
//
#ifndef ANDROID_IPERMISSION_CONTROLLER_SHIM_H
#define ANDROID_IPERMISSION_CONTROLLER_SHIM_H
...
class IPermissionControllerShim : public IInterface
{
public:
    DECLARE_META_INTERFACE(PermissionControllerShim)
...
class BnPermissionControllerShim : public BnInterface<IPermissionControllerShim>
{
public:
...
#endif // ANDROID_IPERMISSION_CONTROLLER_SHIM_H

...
#define LOG_TAG "PermissionControllerShim"
...
class BpPermissionControllerShim : public BpInterface<IPermissionControllerShim>
{
public:
    explicit BpPermissionControllerShim(const sp<IBinder>& impl)
        : BpInterface<IPermissionControllerShim>(impl)
    {
    }
    ...
    {
        Parcel data, reply;
        data.writeInterfaceToken(IPermissionControllerShim::getInterfaceDescriptor());
...
IMPLEMENT_META_INTERFACE(PermissionControllerShim, "android.os.IPermissionControllerShim");

// ----------------------------------------------------------------------

status_t BnPermissionControllerShim::onTransact(
    uint32_t code, const Parcel& data, Parcel* reply, uint32_t flags)
{
    switch(code) {
        case CHECK_PERMISSION_TRANSACTION: {
            CHECK_INTERFACE(IPermissionControllerShim, data, reply);
